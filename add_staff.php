                ...
                <div class="col-lg-12">
                  <div class="card">
                    ...
                    <div class="card-header d-flex align-items-center">
                      ...
                      <h2 class="w3-animate-fading w3-text-white">Add New Staff</h2>
                      </div>
                    </div>
                    <div class="card-body">
                      <form action="admission_form_admin.php" method="POST">
                       ...
                       <div class="row">
                        ...
                        <div class="col-lg-6">
                        <div class="form-group has-success">       
                          <label class="w3-text-orange w3-large" for="admission_id">Staff ID<span class="w3-badge w3-blue">*</span></label>
