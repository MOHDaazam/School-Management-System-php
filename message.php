                ...
                <div class="col-lg-12">
                  <div class="card">
                    ...
                    <div class="card-header d-flex align-items-center">
                      ...
                      <h2 class="w3-animate-fading w3-text-white">Add New Message</h2>
                      </div>
                    </div>
                    <div class="card-body">
                      <form action="admission_form_admin.php" method="POST">
                        ...
                        <div class="form-group has-success">       
                          <label class="w3-text-orange w3-large" for="lname">Recipient<span class="w3-badge w3-blue">*</span></label>
                       ...
                       <div class="row">
                          <div class="col-lg-12">
                            <div class="form-group has-success">
                          <label for="fname" class="w3-text-orange w3-large">Message<span class="w3-badge w3-blue">*</span></label>
                          <textarea rows="5" cols="10" name="fname" id="fname" class="form-control is-valid" placeholder="First Name" required=""></textarea>
                         </div>
                        </div>
                      </div>
