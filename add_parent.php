                ...
                <div class="col-lg-12">
                  <div class="card">
                    ...
                    <div class="card-header d-flex align-items-center">
                      ...
                      <h2 class="w3-animate-fading w3-text-white">Add New Parents</h2>
                      </div>
                    </div>
                    <div class="card-body">
                      <form action="admission_form_admin.php" method="POST">
                       ...
                       <div class="row">
                          <div class="col-lg-6">
                        <div class="form-group has-success">
                          <label class="w3-text-orange w3-large" for="roll">Address<span class="w3-badge w3-blue">*</span></label>
                          <input type="text" name="roll" id="roll" class="form-control is-valid" placeholder="Roll" required="">
                         </div>
                        </div>
                        <div class="col-lg-6">
                        <div class="form-group has-success">       
                          <label class="w3-text-orange w3-large" for="admission_id">Parent ID<span class="w3-badge w3-blue">*</span></label>
                      ...
                      <div class="row">
                       ...
                       <div class="row">
                        ...
                        <div class="form-group has-success">
                          ...
                          <select name="blood_group" class="form-control mb-6 is-valid" required="">
                              <option>A+</option>
                              <option>A-</option>
                              <option>B+</option>
                              <option>B-</option>
                      ...
                      <div class="row">
                          <div class="col-lg-12">
                        <div class="form-group has-success">
                          <label class="w3-text-orange w3-large" for="class">Occupation<span class="w3-badge w3-blue">*</span></label>
                        ...
                        <div class="col-lg-6 w3-leftbar w3-border-green">
                        <div class="form-group has-success">       
                          <label class="w3-text-orange w3-large" for="photo">Upload Parent Photo (150px X 150px)*</label>
