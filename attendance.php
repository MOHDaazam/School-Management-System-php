                ...
                <div class="col-lg-12">
                  <div class="card">
                    ...
                    <div class="card-header d-flex align-items-center">
                      ...
                      <h2 class="w3-animate-fading w3-text-white">Student Attendence</h2>
                      </div>
                    </div>
                    <div class="card-body">
                      <form action="admission_form_admin.php" method="POST">
                       ...
                       <div class="row">
                          <div class="col-lg-6 w3-panl w3-leftbar w3-border-blue">
                            <div class="form-group has-success">
                          <label class="w3-text-orange w3-large" for="dob">Subject Month<span class="w3-badge w3-blue">*</span></label>
                        ...
                        <div class="form-group has-success">       
                          <label class="w3-text-orange w3-large" for="gender">Select Session<span class="w3-badge w3-blue">*</span></label>
                          <select name="gender" id="gender" class="form-control mb-6 is-valid" required="">
