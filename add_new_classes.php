                ...
                <div class="col-lg-12">
                  <div class="card">
                    ...
                    <div class="card-header d-flex align-items-center">
                      ...
                      <h2 class="w3-animate-fading w3-text-white">Add New Classes</h2>
                      </div>
                    </div>
                    <div class="card-body">
                      <form action="admission_form_admin.php" method="POST">
                        <div class="row">
                          ...
                          <label for="name" class="w3-text-orange w3-large">Teacher Name<span class="w3-badge w3-blue">*</span></label>
                        ...
                        <div class="form-group has-success">       
                          <label class="w3-text-orange w3-large" for="lname">ID NO<span class="w3-badge w3-blue">*</span></label>
                       ...
                       <div class="row">
                          <div class="col-lg-6">
                        <div class="form-group has-success">
                          <label class="w3-text-orange w3-large" for="roll">Time<span class="w3-badge w3-blue">*</span></label>
                          <input type="text" name="roll" id="roll" class="form-control is-valid" placeholder="Roll" required="">
                         </div>
                        </div>
                        <div class="col-lg-6">
                        <div class="form-group has-success">       
                          <label class="w3-text-orange w3-large" for="admission_id">Phone<span class="w3-badge w3-blue">*</span></label>
                          <input type="text" name="admission_id" id="admission_id" class="form-control is-valid" placeholder="Admission ID" required="">
                        </div>
                      </div>
                      </div>
                      <div class="row">
                        ...
                        <div class="col-lg-6 w3-leftbar w3-border-green">
                        <div class="form-group has-success">       
                          <label class="w3-text-orange w3-large" for="phone">Gender<span class="w3-badge w3-blue">*</span></label>
                       ...
                       <div class="row">
                          <div class="col-lg-6">
                        <div class="form-group has-success">
                          <label class="w3-text-orange w3-large" for="gender">Class<span class="w3-badge w3-blue">*</span></label>
                        ...
                        <div class="col-lg-6">
                        <div class="form-group has-success">       
                          <label class="w3-text-orange w3-large" for="dob">Subject<span class="w3-badge w3-blue">*</span></label>
                           <select name="gender" id="gender" class="form-control mb-6 is-valid" required="">
                      ...
                      <div class="row">
                          <div class="col-lg-6">
                        <div class="form-group has-success">
                          <label class="w3-text-orange w3-large" for="gender">Section<span class="w3-badge w3-blue">*</span></label>
                         <select name="section" class="form-control mb-6 is-valid" required="">
                              <option>Pakhi</option>
                              <option>Chaya</option>
                              <option>Modur</option>
                        ...
                        <div class="col-lg-6">
                        <div class="form-group has-success">       
                          <label class="w3-text-orange w3-large" for="dob">Date<span class="w3-badge w3-blue">*</span></label>
                          <input type="date" name="email" id="email" class="form-control is-valid" required="">
                        </div>
                      </div>
                      </div>
