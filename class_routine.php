                ...
                <div class="col-lg-12">
                  <div class="card">
                    ...
                    <div class="card-header d-flex align-items-center">
                      ...
                      <h2 class="w3-animate-fading w3-text-white">Add Class Routine</h2>
                      </div>
                    </div>
                    <div class="card-body">
                      <form action="admission_form_admin.php" method="POST">
                        <div class="row">
                          ...
                          <label for="name" class="w3-text-orange w3-large">Subject Name<span class="w3-badge w3-blue">*</span></label>
                       ...
                       <div class="row">
                        ...
                        <div class="col-lg-6">
                        <div class="form-group has-success">       
                          <label class="w3-text-orange w3-large" for="dob">Subject Code<span class="w3-badge w3-blue">*</span></label>
                           <select name="gender" id="gender" class="form-control mb-6 is-valid" required="">
                              <option>B01</option>
                              <option>E02</option>
                              <option>M03</option>
