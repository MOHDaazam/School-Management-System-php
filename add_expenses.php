                ...
                <div class="col-lg-12">
                  <div class="card">
                    ...
                    <div class="card-header d-flex align-items-center">
                      ...
                      <h2 class="w3-animate-fading w3-text-white">Add New Expense</h2>
                      </div>
                    </div>
                    <div class="card-body">
                      <form action="admission_form_admin.php" method="POST">
                        <div class="row">
                          ...
                          <label for="name" class="w3-text-orange w3-large">Name<span class="w3-badge w3-blue">*</span></label>
                       ...
                       <div class="row">
                          <div class="col-lg-6">
                        <div class="form-group has-success">
                          <label class="w3-text-orange w3-large" for="roll">Amount<span class="w3-badge w3-blue">*</span></label>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-6 w3-leftbar w3-border-green">
                        <div class="form-group has-success">       
                          <label class="w3-text-orange w3-large" for="phone">Status<span class="w3-badge w3-blue">*</span></label>
                       ...
                       <div class="row">
                          <div class="col-lg-6">
                        <div class="form-group has-success">
                          <label class="w3-text-orange w3-large" for="gender">Date<span class="w3-badge w3-blue">*</span></label>
                          <input type="date" name="email" id="email" class="form-control is-valid" required="">
                         </div>
                        </div>
                        <div class="col-lg-6">
                        <div class="form-group has-success">       
                          <label class="w3-text-orange w3-large" for="dob">Expense Type<span class="w3-badge w3-blue">*</span></label>
                           <select name="gender" id="gender" class="form-control mb-6 is-valid" required="">
