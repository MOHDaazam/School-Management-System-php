                ...
                <div class="col-lg-12">
                  <div class="card">
                    ...
                    <div class="card-header d-flex align-items-center">
                      ...
                      <h2 class="w3-animate-fading w3-text-white">Add New Grade</h2>
                      </div>
                    </div>
                    <div class="card-body">
                      <form action="admission_form_admin.php" method="POST">
                        <div class="row">
                          ...
                          <label for="name" class="w3-text-orange w3-large">Grade Name<span class="w3-badge w3-blue">*</span></label>
                        ...
                        <div class="form-group has-success">       
                          <label class="w3-text-orange w3-large" for="roll">Percentage From<span class="w3-badge w3-blue">*</span></label>
                       ...
                       <div class="row">
                          <div class="col-lg-6">
                        <div class="form-group has-success">
                          <label class="w3-text-orange w3-large" for="gender">Grade Point<span class="w3-badge w3-blue">*</span></label>
                        ...
                        <div class="col-lg-6">
                        <div class="form-group has-success">       
                          <label class="w3-text-orange w3-large" for="roll">Percentage Upto<span class="w3-badge w3-blue">*</span></label>
                          <input type="text" name="roll" id="roll" class="form-control is-valid" placeholder="Roll" required="">
                        </div>
                      </div>
                      </div>
                      <div class="row">
                        <div class="col-lg-12">
                        <div class="form-group has-success">       
                          <label class="w3-text-orange w3-large" for="dob">Comments<span class="w3-badge w3-blue">*</span></label>
                          <textarea rows="5" cols="10" class="form-control is-valid" placeholder="Comments" required=""></textarea>
                        </div>
                      </div>
                      </div>
