                    ...
                    <div class="card-body">
                      <form action="admission_form_admin.php" method="POST">
                        <div class="row">
                          ...
                          <label for="fname" class="w3-text-orange w3-large">Hostel Name<span class="w3-badge w3-blue">*</span></label>
                        ...
                        <div class="form-group has-success">       
                          <label class="w3-text-orange w3-large" for="lname">Room Name<span class="w3-badge w3-blue">*</span></label>
                      ...
                      <div class="row">
                          <div class="col-lg-6">
                        <div class="form-group has-success">
                          <label class="w3-text-orange w3-large" for="class">Room Type<span class="w3-badge w3-blue">*</span></label>
                        ...
                        <div class="col-lg-6">
                        <div class="form-group has-success">       
                          <label class="w3-text-orange w3-large" for="section">Number Of Bed<span class="w3-badge w3-blue">*</span></label>
                        ...
                        <div class="form-group has-success">
                          <label class="w3-text-orange w3-large" for="biography">Cost Per Bed<span class="w3-badge w3-blue">*</span></label>
                           <input type="text" name="biography" id="biography" class="form-control is-valid" placeholder="Biography" required="">
                         </div>
                        </div>
                      </div>
