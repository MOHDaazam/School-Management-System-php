                ...
                <div class="col-lg-12">
                  <div class="card">
                    ...
                    <div class="card-header d-flex align-items-center">
                      ...
                      <h2 class="w3-animate-fading w3-text-white">Add New Transport</h2>
                      </div>
                    </div>
                    <div class="card-body">
                      <form action="admission_form_admin.php" method="POST">
                        <div class="row">
                          ...
                          <label for="fname" class="w3-text-orange w3-large">Route Name<span class="w3-badge w3-blue">*</span></label>
                        ...
                        <div class="form-group has-success">       
                          <label class="w3-text-orange w3-large" for="lname">Vehicle Number<span class="w3-badge w3-blue">*</span></label>
                       ...
                       <div class="row">
                          <div class="col-lg-6">
                        <div class="form-group has-success">
                          <label class="w3-text-orange w3-large" for="roll">Driver Name<span class="w3-badge w3-blue">*</span></label>
                          <input type="text" name="roll" id="roll" class="form-control is-valid" placeholder="Roll" required="">
                         </div>
                        </div>
                        <div class="col-lg-6">
                        <div class="form-group has-success">       
                          <label class="w3-text-orange w3-large" for="admission_id">License Number<span class="w3-badge w3-blue">*</span></label>
                      ...
                      <div class="row">
                        ...
                        <div class="form-group has-success">
                          <label class="w3-text-orange w3-large" for="email">Phone Number<span class="w3-badge w3-blue">*</span></label>
